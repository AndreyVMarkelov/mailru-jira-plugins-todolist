...
function ru_mail_addToDoItem(event, cfId, currtime) {
    ...
    if (todoinput) {
        ...
        //--> add row
        jQuery("#" + currtime).append("<tr><td class=\"checkboxcolumn\"><input onchange=\"ru_mail_changeToDoItem(event, '" + cfId + "');\" class=\"todocheckbox\" type=\"checkbox\" value=\"true\"/></td><td class=\"wrapcolumn\"><span class=\"todo_undone\">" + todoinput + "</span></td><td><a href=\"#\" class=\"todoremovebtn\" onclick=\"ru_mail_removeToDoItem(event, '$customField.id');\"/></td></tr>");
